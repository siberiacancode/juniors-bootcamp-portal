...
export const FigmaIcon = (props: SVGProps<SVGSVGElement>) => (
  <svg height='1em' width='1em' xmlns='http://www.w3.org/2000/svg' viewBox='0 0 128 128' {...props}>
    ...
    <path
      ...
      fill='#a259ff'
    />
    <path d='M24 21.5C24 9.6 33.6 0 45.5 0H67v43H45.5C33.6 43 24 33.4 24 21.5m0 0' fill='#f24e1e' />
    <path d='M67 0h21.5C100.4 0 110 9.6 110 21.5S100.4 43 88.5 43H67zm0 0' fill='#ff7262' />
    <path
