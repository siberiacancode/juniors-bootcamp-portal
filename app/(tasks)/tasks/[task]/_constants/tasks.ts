...
export type TaskInfo = typeof carsTask | typeof cinemaTask | typeof deliveryTask | typeof pizzaTask;

export type TaskName = 'cars' | 'cinema' | 'delivery' | 'pizza';

export const TASKS_MAP: Record<TaskName, TaskInfo> = {
  cinema: cinemaTask,
  pizza: pizzaTask,
