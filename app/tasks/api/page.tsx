      ...
      <div className='flex flex-col gap-6 sm:flex-row'>
        {API_CARDS.map(({ description, href, title }) => (
          <Link key={href} className='w-full' href={href} rel='noopener noreferrer' target='_blank'>
            <Card className='h-full gap-6 shadow-[3px_3px_0_0_var(--color-foreground)] sm:py-16'>
              <CardHeader className='px-4 sm:px-12'>
                <h2 className='font-nunito text-5xl font-extrabold drop-shadow-[3px_0_0_rgba(225,0,152,1)] xl:text-8xl'>
                  {title}
                </h2>
              </CardHeader>
